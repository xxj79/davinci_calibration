...
void move_tip(){
        //g_got_new_pose = true;
        g_trajectory_point1 = g_trajectory_point2; 
        g_trajectory_point2.positions[0] += 0.1;
        g_trajectory_point2.positions[1] += 0.07;
        g_trajectory_point2.positions[2] += 0.02;
        g_trajectory_point2.positions[3] += 0.2;
        g_trajectory_point2.positions[4] += 0.15;
        g_trajectory_point2.positions[5] += 0.13;
